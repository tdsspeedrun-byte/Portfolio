...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Image inside the front of a flip card */
        .card-image {
            width: 100%;
            height: 120px;
            object-fit: cover;
        ...
        /* Image inside a static card (e.g. project thumbnail) */
        .static-card-image {
            width: calc(100% + 3rem);
    ...
    <section id="about">
        ...
        <div class="about-container">
            <div class="about-image-wrapper">
                <img src="Profile.jpeg" alt="Ngan Kwan Teng" class="about-image">
            </div>
    ...
    <section id="skills">
        ...
        <div class="portfolio-grid">
            ...
            <div class="flip-card" onclick="flipCard(this)">
                <div class="flip-card-inner">
                    <div class="card-front">
                        <img src="Cybersecurity.jpg" alt="Cybersecurity" class="card-image">
                        <h3>Cybersecurity</h3>
            ...
            <div class="flip-card" onclick="flipCard(this)">
                <div class="flip-card-inner">
                    <div class="card-front">
                        <img src="MachineLearning.jpg" alt="Machine Learning Systems" class="card-image">
            ...
            <div class="flip-card" onclick="flipCard(this)">
                <div class="flip-card-inner">
                    <div class="card-front">
                        <img src="SensorData.jpg" alt="Sensor Data & Control" class="card-image">
    ...
    <section id="projects">
        ...
        <div class="portfolio-grid">
            ...
            <a href="SmartGardening.html" class="static-card">
                <img src="IotSmartGarden.jpg" alt="IoT Smart Gardening System" class="static-card-image">
                <div>
            ...
            <a href="CloudEngineering.html" class="static-card">
                <img src="CloudEngineering.jpg" alt="Cloud Engineering Project" class="static-card-image">
                <div>
                    <h3>Cloud Engineering Project</h3>
                    <p>Designed and implemented scalable cloud solutions for data processing and storage.</p>
                </div>
                <div class="project-tags">
                    <span>AWS</span>
                    <span>EC2</span>
            ...
            <a href="DataEngineering.html" class="static-card">
                <img src="DataEngineering.jpg" alt="Data Engineering Project" class="static-card-image">
                <div>
                    <h3>Data Engineering Project</h3>
                    <p>Designed and implemented efficient data pipelines for processing and analyzing large volumes of data.</p>
                </div>
                <div class="project-tags">
                    <span>Python</span>
                    <span>Arduino</span>
    ...
    <section id="others">
        ...
        <div class="portfolio-grid">
            <div class="static-card">
                <img src="AppliedCalculus.jpg" alt="Applied Calculus" class="static-card-image">
                <h3>Applied Calculus</h3>
                <p>Have a higher understanding of calculus principles and their applications in engineering and data analysis.</p>
            </div>
            <div class="static-card">
                <img src="FourierSeries.png" alt="Fourier Series" class="static-card-image">
                <h3>Fourier Series</h3>
                <p>Understanding of Fourier analysis for signal processing and frequency domain analysis.</p>
            </div>
            <div class="static-card">
                <img src="DataVisualisation.jpg" alt="Data Visualization" class="static-card-image">
